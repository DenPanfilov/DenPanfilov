...
Итоги: По результатам проведения указанного комплекса работ было выполнено более 100 проверок и обнаружен суммарно 21 баг, в том числе 2 критичных бага и 1 баг в бэкенде. На основании этого было сделано заключение о том, что указанные разделы личного кабинета пока не готовы к выпуску и нуждаются в доработке.

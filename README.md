...
Провести Smoke, Функциональное, Регрессионное, Приемочное тестирование, а так же тестирование API;
Оформить отчет по результатам тестирования.
...
Составить тест-план;
Подготовить тестовую документацию;
Провести следующие виды работ: Функциональное тестирование (на уровне компонентов, интеграции и системы); Интеграционное тестирование; UX/UI-тестирование; Проверка совместимости; Проверка доступности; Тестирование API; Тестирование прерываний; Тестирование установки;
Оформить отчет по результатам тестирования.
